...
import Vizimg from "../../../image/Other/Dijkstragif.gif";
  ...
  return (
    <Grid container spacing={2}>
      <Grid item xs={12}>
        ...
        >
          <h2 style={{width:"100%"}}>Dijkstra Algorithhm to find the shortest path</h2>
          <img src={Vizimg} alt="" style={{ width: "25%" }} />
        </Container>
      </Grid>
      <Grid item xs={12} sm={7}>
        <Container>
          ...
          <p>
            ...
            spanning tree. Like Prim’s MST, generate a SPT (shortest path tree)
            with a given source as a root. Maintain two sets, one set contains
            vertices included in the shortest-path tree, other set includes
            vertices not yet included in the shortest-path tree. At every step
            of the algorithm, find a vertex that is in the other set (set not
