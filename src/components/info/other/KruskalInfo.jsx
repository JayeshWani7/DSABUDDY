...
import Vizimg from '../../../image/Other/Kruskalgif.gif'
  ...
  return (
    <Grid container spacing={2}>
      ...
      <Container
        ...
        >
          <h2 style={{ width: "100%" }}>Find MST suing Kruskal's algorithm</h2>
      ...
      <Grid item xs={12} sm={7}>
        <Container>
          ...
          <h4> Working of Kruskal's Algorithm:</h4>
          <p>
          ...
          <p>
            <br />• First, sort all the edges from low weight to high.
            <br />• Now, take the edge with the lowest weight and add it to the
            spanning tree. If the edge to be added creates a cycle, then reject
            the edge.
            <br />• Continue to add the edges until we reach all vertices, and a
            minimum spanning tree is created.
          </p>
          <p>The applications of Kruskal's algorithm are -</p>
          <p>
            <br />• Kruskal's algorithm can be used to layout electrical wiring among cities.
            <br />• It can be used to lay down LAN connections.
          </p>
        </Container>
      </Grid>
