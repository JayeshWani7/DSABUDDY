...
export function Controller() {
  ...
  const [sortingArray, setSortingArray, searchingElement, setSearchingElement, tabTitle] = useData(
    (state) => [state.sortingArray, state.setSortingArray, state.searchingElement, state.setSearchingElement, state.tabTitle],
    shallow
  );
  ...
  const [searchInput, setSearchInput] = useState(setSearchingElement);
  setSearchingElement(searchInput)
